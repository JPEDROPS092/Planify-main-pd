        ...
        if (error?.response?.data) {
          ...
          if (errorData.username) {
            toast({
              ...
              description: Array.isArray(errorData.username)
            ...
            toast({
              title: "Erro no email",
              description: Array.isArray(errorData.email)
            ...
            toast({
              title: "Erro na senha",
              description: Array.isArray(errorData.password)
