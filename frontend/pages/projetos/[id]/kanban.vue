<template>
  <div class="space-y-8">
    <div class="flex justify-between items-center">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">
          Visualização Kanban e Gerenciamento de Sprints
        </p>
      </div>
      <div class="flex space-x-2">
        <Button
          variant="outline"
          size="sm"
          @click="$router.push(`/projetos/${projectId}`)"
        >
          <svg
        ...
        <Button
          ...
          :class="{ 'bg-blue-50 dark:bg-blue-900': activeTab === 'kanban' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4 mr-1.5"
        ...
        <Button
          ...
          :class="{ 'bg-blue-50 dark:bg-blue-900': activeTab === 'sprint' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4 mr-1.5"
        ...
        <Button
          ...
          :class="{ 'bg-blue-50 dark:bg-blue-900': activeTab === 'list' }"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4 mr-1.5"
    ...
    >
      ...
      <Button variant="outline" size="sm" class="mt-2" @click="fetchProject"
    ...
    <div v-else>
      ...
      <div v-else-if="activeTab === 'sprint'">
        <SprintManagement
          :project-id="projectId"
          @sprints-updated="handleSprintsUpdated"
        />
      </div>
