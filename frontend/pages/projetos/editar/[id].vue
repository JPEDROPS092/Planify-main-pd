<template>
  <div class="container mx-auto p-4 md:p-6">
    ...
    >
      ...
      <p>
        {{
          error.message || 'Não foi possível carregar os detalhes do projeto.'
        }}
      </p>
    ...
    <div v-else class="space-y-6">
        ...
        <form @submit.prevent="updateProject" class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
              Projetos arquivados não aparecem na lista principal, mas podem ser
              acessados através dos filtros.
            </p>
          </div>
      ...
      >
        ...
        <p class="text-sm text-red-600 dark:text-red-400 mb-4">
          As ações abaixo não podem ser desfeitas. Tenha certeza antes de
          prosseguir.
        </p>
        <Button
          variant="destructive"
  ...
  try {
    ...
    projectForm.value = {
      ...
      data_inicio: project.data_inicio
        ? new Date(project.data_inicio).toISOString().split('T')[0]
        : '',
      data_fim: project.data_fim
        ? new Date(project.data_fim).toISOString().split('T')[0]
        : '',
