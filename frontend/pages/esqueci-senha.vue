...
const handleSubmit = async () => {
  try {
    ...
    notify({
      type: 'success',
      message: 'Enviamos instruções para recuperar sua senha. Por favor, verifique seu e-mail.',
    })
    ...
    error.value = err.friendlyMessage || 'Ocorreu um erro ao processar sua solicitação. Tente novamente.'
    notify({
      type: 'error',
      message: error.value
    })
