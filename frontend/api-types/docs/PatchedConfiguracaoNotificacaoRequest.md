...
------------ | ------------- | ------------- | -------------
**usuario** | **number** | Usuário ao qual estas configurações pertencem | [optional] [default to undefined]
...
```typescript
import { PatchedConfiguracaoNotificacaoRequest } from './api';

const instance: PatchedConfiguracaoNotificacaoRequest = {
    usuario,
    tarefa_atribuida,
    tarefa_comentario,
    tarefa_prazo,
