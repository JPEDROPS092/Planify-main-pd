...
watch([() => route.path], async () => {
  ...
  if ((route.path === '/login' || route.path === '/register') && isAuthenticated.value) {
...
<template>
  <div>
              ...
              <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
                <div class="flex-shrink-0 w-full group block">
                  <div class="flex items-center">
                    ...
                    <button @click="handleLogout" class="text-gray-400 hover:text-gray-500">
    ...
    <!-- Toast Container para feedback global -->
    <ToastContainer />
  </div>
</template>
