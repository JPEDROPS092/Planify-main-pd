...
const projects = [
  {
    id: 1,
    titulo: "Planify - Task Management App",
    descricao: "A web application designed to help teams manage tasks, track project progress, and collaborate efficiently.",
    data_inicio: "2024-03-15",
    data_fim: "2025-06-30",
    status: "in_progress",
    status_display: "In Progress",
    prioridade: "high",
    prioridade_display: "High",
    criado_por: 101,
    criador_username: "alice.smith",
    criador_nome: "Alice Smith",
    criado_em: "2024-03-10T10:00:00Z",
    atualizado_em: "2025-06-20T14:30:00Z",
    arquivado: false,
    membros: [
      { id: 101, username: "alice.smith", nome: "Alice Smith" },
      { id: 102, username: "bob.johnson", nome: "Bob Johnson" },
      { id: 103, username: "carol.white", nome: "Carol White" }
    ],
    sprints_count: 12,
    tasks_count: 250,
    progresso: 85,
  ...
  {
    id: 2,
    titulo: "E-commerce Redesign",
    descricao: "Revamp the existing e-commerce platform with a new UI/UX, improved performance, and new payment gateways.",
    data_inicio: "2024-01-20",
    data_fim: "2025-07-15",
    status: "planning",
    status_display: "Planning",
    prioridade: "medium",
    prioridade_display: "Medium",
    criado_por: 104,
    criador_username: "david.brown",
    criador_nome: "David Brown",
    criado_em: "2024-01-10T09:00:00Z",
    atualizado_em: "2025-06-24T11:00:00Z",
    arquivado: false,
    membros: [
      { id: 104, username: "david.brown", nome: "David Brown" },
      { id: 105, username: "emily.davis", nome: "Emily Davis" }
    ],
    sprints_count: 0, // No sprints started yet as it's in planning
    tasks_count: 15, // Initial tasks for planning phase
    progresso: 10,
    dias_restantes: 20,
    atrasado: false,
  },
  {
    id: 3,
    titulo: "Mobile App Development - V1",
    descricao: "Develop the first version of a native mobile application for both iOS and Android platforms.",
    ...
    prioridade_display: "High",
    criado_por: 102,
    criador_username: "bob.johnson",
    criador_nome: "Bob Johnson",
    criado_em: "2023-08-25T14:00:00Z",
    atualizado_em: "2024-06-01T10:00:00Z",
    arquivado: true, // Marked as archived since it's completed
    membros: [
      { id: 102, username: "bob.johnson", nome: "Bob Johnson" },
      { id: 106, username: "frank.green", nome: "Frank Green" },
      { id: 107, username: "grace.lee", nome: "Grace Lee" }
    ],
    sprints_count: 10,
    tasks_count: 180,
    progresso: 100,
