...
export const useDocumentService = () => {
  ...
  const updateDocument = async (documentId, documentData) => {
    return withLoading(async () => {
      try {
        const updatedDocument = await documentsApi.updateDocumento(
          documentId,
          documentData
        );
  ...
  const getDocumentosByRisco = async (riscoId) => {
    return withLoading(async () => {
      try {
        const response = await documentsApi.listDocumentos({ risco: riscoId });
        return response;
      } catch (err) {
        error.value = handleApiError(err);
        throw err;
  ...
  const getDocumentosByCusto = async (custoId) => {
    return withLoading(async () => {
      try {
        const response = await documentsApi.listDocumentos({ custo: custoId });
        return response;
      } catch (err) {
        error.value = handleApiError(err);
        throw err;
