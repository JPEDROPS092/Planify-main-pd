 ...
 * @param payload Dados do custo
 */
export async function updateCusto(id: number, payload: CustoRequest): Promise<Custo> {
  // Se houver um comprovante, usar FormData
  if (payload.comprovante) {
    const formData = createFormData(payload)
 ...
 */
export async function partialUpdateCusto(id: number, payload: Partial<CustoRequest>): Promise<Custo> {
  // Se houver um comprovante, usar FormData
  if (payload.comprovante) {
    const formData = createFormData(payload)
 ...
 */
export async function createCategoria(payload: CategoriaRequest): Promise<Categoria> {
 ...
 * @param payload Dados da categoria
 */
export async function updateCategoria(id: number, payload: CategoriaRequest): Promise<Categoria> {
  return getApi()<Categoria>(`/api/costs/categorias/${id}/`, {
    method: 'PUT',
    body: payload
  })
 ...
 */
export async function partialUpdateCategoria(id: number, payload: Partial<CategoriaRequest>): Promise<Categoria> {
  return getApi()<Categoria>(`/api/costs/categorias/${id}/`, {
    method: 'PATCH',
    body: payload
  })
 ...
 * @param payload Dados do alerta
 */
export async function updateAlerta(id: number, payload: AlertaRequest): Promise<Alerta> {
  return getApi()<Alerta>(`/api/costs/alertas/${id}/`, {
    method: 'PUT',
    body: payload
  })
 ...
 */
export async function partialUpdateAlerta(id: number, payload: Partial<AlertaRequest>): Promise<Alerta> {
  return getApi()<Alerta>(`/api/costs/alertas/${id}/`, {
    method: 'PATCH',
    body: payload
  })
 ...
 * @param payload Dados do orçamento
 */
export async function updateOrcamentoProjeto(id: number, payload: any): Promise<any> {
  return getApi()<any>(`/api/costs/orcamentos-projeto/${id}/`, {
    method: 'PUT',
    body: payload
  })
 ...
 */
export async function partialUpdateOrcamentoProjeto(id: number, payload: any): Promise<any> {
  return getApi()<any>(`/api/costs/orcamentos-projeto/${id}/`, {
    method: 'PATCH',
    body: payload
  })
...
export async function retrieveProjetosSemOrcamento(): Promise<any[]> {
  return getApi()<any[]>('/api/costs/orcamentos-projeto/projetos_sem_orcamento/', {
    method: 'GET'
  })
}
