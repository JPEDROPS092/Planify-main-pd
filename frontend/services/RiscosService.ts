...
export class RiscosService {
     ...
     * @throws ApiError
     */
    public apiRisksHistoricoRetrieve(
        id: number,
     ...
     * @throws ApiError
     */
    public apiRisksRiscosPartialUpdate(
        id: number,
     ...
     * @throws ApiError
     */
    public apiRisksRiscosAtualizarStatusCreate(
        id: number,
        requestBody: RiscoRequest,
     ...
     * @throws ApiError
     */
    public apiRisksRiscosHistoricoRetrieve(
        id: number,
    ): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'GET',
     ...
     * @throws ApiError
     */
    public apiRisksRiscosExcluirVariosDestroy(): CancelablePromise<any> {
        return this.httpRequest.request({
            method: 'DELETE',
