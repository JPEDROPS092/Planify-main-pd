...
export const getProjectsHistoryRetrieveMockHandler = (overrideResponse?: HistoricoStatusProjeto | ((info: Parameters<Parameters<typeof http.get>[1]>[0]) => Promise<HistoricoStatusProjeto> | HistoricoStatusProjeto)) => {
  return http.get('*/api/projects/history/:id/', async (info) => {await delay(1000);
...
export const getProjectsMock = () => [
  getProjectsHistoryRetrieveMockHandler()
]
