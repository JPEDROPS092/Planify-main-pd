...
export class DocumentosService {
     ...
     * @throws ApiError
     */
    public static documentsAdicionarComentarioCreate(
        id: number,
        requestBody?: any,
     ...
     * @throws ApiError
     */
    public static documentsDocumentHistoryRetrieve(
        id: number,
     ...
     * @throws ApiError
     */
    public static documentsComentariosList(
        autor?: number,
        documento?: number,
        ordering?: string,
        page?: number,
     ...
     * @throws ApiError
     */
    public static documentsComentariosCreate(
     ...
     * @throws ApiError
     */
    public static documentsComentariosRetrieve(
        id: number,
    ): CancelablePromise<Comentario> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static documentsComentariosUpdate(
        id: number,
        requestBody: ComentarioRequest,
    ): CancelablePromise<Comentario> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static documentsComentariosPartialUpdate(
        id: number,
     ...
     * @throws ApiError
     */
    public static documentsComentariosDestroy(
        id: number,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
            method: 'DELETE',
