...
export class DocumentosService {
     ...
     * @throws ApiError
     */
    public apiDocumentsPartialUpdate(
        id: number,
     ...
     * @throws ApiError
     */
    public apiDocumentsDocumentHistoryRetrieve(
        id: number,
