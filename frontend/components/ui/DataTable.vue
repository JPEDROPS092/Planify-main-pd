<template>
  <div
    class="w-full overflow-hidden rounded-lg border border-gray-200 dark:border-gray-700"
  >
    <!-- Cabeçalho da tabela -->
    <div
      class="flex items-center justify-between bg-gray-50 p-4 dark:bg-gray-800"
    >
          ...
          <tr>
            ...
            >
              <div class="flex flex-col items-center justify-center">
                ...
                <p v-if="searchQuery" class="mt-1 text-xs">
    ...
    <div
      ...
      class="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 dark:border-gray-700 dark:bg-gray-900 sm:px-6"
    >
