  ...
  <div>
    <div class="mb-8">
      ...
      <p class="text-muted-foreground">
        Visão geral dos projetos e seu progresso
      </p>
    </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p class="text-xs text-muted-foreground">
            De {{ totalMilestones }} marcos planejados
          </p>
        </CardContent>
        <CardFooter>
          <NuxtLink
      ...
      <Card>
        ...
        >
          <CardTitle class="text-sm font-medium"
            >Aprovações Pendentes</CardTitle
          >
          ...
          <div v-for="project in projects" :key="project.id" class="space-y-2">
            ...
            <div class="space-y-1">
              <div class="flex items-center justify-between text-xs">
                <span>Orçamento</span>
                <span
                  >{{ formatCurrency(project.budget.spent) }} de
                  {{ formatCurrency(project.budget.total) }}</span
                >
              </div>
              <div class="h-2 w-full rounded-full bg-muted">
                <div
    ...
    <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <Card>
        ...
        <CardContent>
          <div class="space-y-4">
            <div
              v-for="approval in pendingApprovalItems"
              :key="approval.id"
            ...
            >
              ...
              <div class="flex-1">
                ...
                <p class="mt-1 text-xs text-muted-foreground">
                  Solicitado em: {{ formatDate(approval.requestDate) }}
                </p>
        ...
        <CardContent>
          <div class="space-y-4">
            ...
            >
              ...
              <p class="mt-1 text-xs text-muted-foreground">
                Não há marcos programados para o futuro próximo.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <CardContent>
        <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div class="rounded-lg border p-4">
            ...
            <p class="text-xs text-muted-foreground">
              Orçamento aprovado para todos os projetos
            </p>
          </div>
          ...
          <div class="rounded-lg border p-4">
            ...
            <p class="text-xs text-muted-foreground">
              {{ financialSummary.spentPercentage }}% do orçamento total
            </p>
          </div>
          ...
          <div class="rounded-lg border p-4">
            ...
            <div class="mt-2 text-2xl font-bold">
              {{ formatCurrency(financialSummary.projectedSavings) }}
            </div>
            <p class="text-xs text-muted-foreground">
        ...
        <div class="mt-6">
          ...
          <div class="space-y-4">
            <div
              v-for="category in financialSummary.spendingByCategory"
              :key="category.name"
              class="space-y-2"
            >
              <div class="flex items-center justify-between">
    ...
    pendingApprovalItems.value = [
      {
        ...
        description:
          'Documento de especificação técnica para o módulo financeiro',
        type: 'documento',
        project: 'Sistema ERP',
      ...
      {
        id: 2,
        title: 'Aumento de Orçamento',
        description:
          'Solicitação de aumento de orçamento para desenvolvimento mobile',
        type: 'orcamento',
      ...
      },
      {
        ...
        description:
          'Solicitação de extensão de prazo para entrega da integração',
        type: 'prazo',
