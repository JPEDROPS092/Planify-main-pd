<template>
  <div class="space-y-6">
    <div class="flex justify-between items-center">
      <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Exportar Dados do Projeto</h3>
    </div>
    ...
    <div v-else-if="error" class="text-center text-red-500 dark:text-red-400 py-6">
      ...
      <Button variant="outline" size="sm" class="mt-2" @click="initialize">Tentar Novamente</Button>
    </div>
    <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Opções de exportação -->
        <div class="space-y-4">
          <h4 class="font-medium text-gray-700 dark:text-gray-300">Selecione os dados a exportar:</h4>
          ...
          <div class="space-y-2">
            <div class="flex items-center">
              ...
              />
              <label for="export-project-details" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Detalhes do Projeto
              </label>
            </div>
            ...
            <div class="flex items-center">
              <input 
                ...
                class="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <label for="export-tasks" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Tarefas
              </label>
            </div>
            ...
            <div class="flex items-center">
              <input 
                ...
                class="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <label for="export-team" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Equipe
              </label>
            </div>
            ...
            <div class="flex items-center">
              <input 
                ...
                class="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <label for="export-risks" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Riscos
              </label>
            </div>
            ...
            <div class="flex items-center">
              <input 
                ...
                class="h-4 w-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <label for="export-costs" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                Custos
              </label>
            </div>
          </div>
        ...
        <div class="space-y-4">
          <h4 class="font-medium text-gray-700 dark:text-gray-300">Formato de exportação:</h4>
          ...
          <div class="space-y-2">
            <div class="flex items-center">
              ...
              />
              <label for="format-csv" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div class="flex items-center">
              <input 
                ...
                class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700"
              />
              <label for="format-json" class="ml-2 text-sm text-gray-700 dark:text-gray-300">
      ...
      <div class="mt-6 text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-4">
        ...
        <ul class="list-disc pl-5 space-y-1">
          <li>Os arquivos CSV podem ser abertos diretamente no Excel ou outros aplicativos de planilha.</li>
          <li>Os arquivos JSON são úteis para integração com outros sistemas ou para backup de dados.</li>
...
async function exportData() {
  ...
  try {
    ...
    if (exportOptions.value.projectDetails) params.append('include_project', 'true')
