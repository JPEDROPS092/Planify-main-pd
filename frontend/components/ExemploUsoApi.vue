...
<template>
  <div class="exemplo-uso-api">
    ...
    <div v-if="isAuthenticated" class="mb-6 p-4 border rounded-lg">
      ...
      <div v-else-if="projetos.length === 0" class="py-4 text-center text-gray-500">
        ...
        >
          <div class="flex justify-between">
            <div>
              ...
              <p class="text-sm text-gray-600">{{ projeto.descricao || 'Sem descrição' }}</p>
    ...
    <div v-if="isAuthenticated && currentUser" class="p-4 border rounded-lg">
      ...
      <div class="space-y-2">
        ...
        <p><strong>Último login:</strong> {{ currentUser.last_login || 'N/A' }}</p>
      </div>
      <div class="mt-4">
        <button 
          @click="logout" 
