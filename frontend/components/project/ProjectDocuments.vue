<template>
  <div class="space-y-4">
    <div class="flex justify-between items-center">
      <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-200">Documentos do Projeto</h3>
      <button
        v-if="canAddDocument"
    ...
    <div v-else-if="documents.length === 0" class="py-8 text-center">
      ...
      <p class="mt-2 text-gray-500 dark:text-gray-400">Nenhum documento adicionado a este projeto</p>
      <button
        v-if="canAddDocument"
        @click="showAddDocumentModal = true"
    ...
    <div v-else class="space-y-3">
      ...
      >
        <div class="flex items-center space-x-3">
          ...
          <div>
            <h4 class="font-medium text-gray-800 dark:text-gray-200">{{ document.title }}</h4>
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Adicionado por {{ document.created_by?.name || 'Usuário' }} em {{ formatDate(document.created_at) }}
            </p>
          </div>
        </div>
