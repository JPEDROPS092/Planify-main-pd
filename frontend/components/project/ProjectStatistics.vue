  ...
  <div class="project-statistics">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
        <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Tarefas por Status</h3>
        <div class="h-48">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
        <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Progresso do Projeto</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
        <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Riscos por Severidade</h3>
        <div class="h-48">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
        <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Custos por Categoria</h3>
        <div class="h-48">
          <canvas ref="costCategoryChart"></canvas>
        </div>
        <div class="mt-2 text-center text-xs">
          <div class="flex justify-center space-x-4">
            <span class="text-gray-600 dark:text-gray-400">Total: R$ {{ totalCost.toLocaleString('pt-BR') }}</span>
...
import { useCostService } from '~/services/api/costs'
...
function updateCharts() {
  ...
  if (progressChartInstance) {
    progressChartInstance.data.datasets[0].data = [progressPercentage.value, 100 - progressPercentage.value]
