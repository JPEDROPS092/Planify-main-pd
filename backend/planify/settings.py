...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY", "django-insecure-p1e@s3ch@ng3th1sk3y1npr0duct10n"
)
...
TEMPLATES: List[Dict[str, Any]] = [
    {
        ...
        ],  # Diretório customizado para templates
...
)  # Pasta onde os arquivos estáticos são coletados para produção
...
EMAIL_BACKEND = (
    "django.core.mail.backends.smtp.EmailBackend"  # Backend SMTP padrão do Django
)
...
)  # Usuário do email (use env var)
EMAIL_HOST_PASSWORD = os.environ.get(
    "EMAIL_HOST_PASSWORD", "CONFIGURE_EMAIL_PASSWORD_IN_ENV"
)  # Senha do email (use env var)
